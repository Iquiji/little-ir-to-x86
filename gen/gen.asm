...
section .data
static6_actual db "cust_func",0h ; Autogen
...
static8_actual db "cust_func",0h ; Autogen
...
static4_actual db "n",0h ; Autogen
...
static1_actual db "n",0h ; Autogen
...
_0:
    ...
    mov esi, dword[vreg26] ; LinearInstruction::Return
    mov [ebp+12], esi
...
main:
    ...
    push static6_actual ; LinearInstruction::Assign
    push dword[vreg28]
    push dword[current_scope]
    ...
    add esp, 8
    pop esi
    mov dword[vreg29],esi

    push dword[vreg29] ; LinearInstruction::PushToStack
    ...
    mov dword[vreg33],static9_data_ptr_struc ; LinearInstruction::StaticRefToRegister
    ...
    mov esi, dword[vreg40] ; linked_list_reg ; LinearInstruction::LinkedListAdd
    mov edi, dword[vreg39] ; input_reg
    push esi 
    push dword edi
    call add_to_linked_list
    add esp,8
    ...
    mov esi,[vreg42] ; LinearInstruction::Call
    mov edi,[vreg41]
    push __empty_to_output_to ; output here 
    push edi
    push esi
